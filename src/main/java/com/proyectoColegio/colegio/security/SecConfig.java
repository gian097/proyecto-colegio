package com.proyectoColegio.colegio.security;

import com.proyectoColegio.colegio.handler.CustomSuccessHandler;
...
public class SecConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers("/","/VerColegios/**").hasRole("ADMIN")
                .antMatchers("/VerEmpleados/**").hasRole("ADMIN")
                .antMatchers("/Colegio/**").hasRole("ADMIN")
